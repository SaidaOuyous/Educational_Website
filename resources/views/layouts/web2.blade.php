...
<div id="sidebar" class=" fixed top-50 left-0 p-5 w-83">
    <div class="p-2">
        ...
        <p>Menu  :</p>
        <a href="/exercicesprogrammationweb" class="block py-2 px-4 border-b border-gray-300">
            <img src="/images/html.png" alt="Home Icon" class="inline-block mr-2 w-10">
            HTML   </a>
        <a href="/cssexercices" class="block py-2 px-4 border-b border-gray-300">
            <img src="/images/css.png" alt="About Icon" class="inline-block mr-2 w-10">
            CSS 
        </a>
        <a href="/jsexercices" class="block py-2 px-4 border-b border-gray-300">
            <img src="/images/js.png" alt="Services Icon" class="inline-block mr-2 w-10">
            JavaScript
        </a>
        <a href="/phpexercices" class="block py-2 px-4 border-b border-gray-300">
